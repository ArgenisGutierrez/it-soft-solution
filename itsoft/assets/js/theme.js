$(document).ready(function () {
  ...
  $(".slider-carousel2").owlCarousel({
    ...
    nav: true,
    navText: [
      " <i class='fas fa-long-arrow-alt-left'><span>01</span>",
      " <span>02</span><i class='fas fa-long-arrow-alt-right'></i>",
    ],
    responsive: {
      0: {
        items: 1,
  ...
  $(".team-member-icon").click(function () {
    $(this)
      .parents(".team-member-single-box")
      .find(".team-social-address-two")
      .toggleClass("active");
  });
